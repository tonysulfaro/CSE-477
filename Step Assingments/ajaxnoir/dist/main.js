...
const Stars = function (sel) {
    ...
    var table = jquery__WEBPACK_IMPORTED_MODULE_0___default()(sel + " table");  // The table tag
...
jquery__WEBPACK_IMPORTED_MODULE_3___default()(document).ready(function() {
    new _Login__WEBPACK_IMPORTED_MODULE_1__["Login"]("#login");
    new _Stars__WEBPACK_IMPORTED_MODULE_2__["Stars"]('#stars');
});
